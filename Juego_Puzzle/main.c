...
int BuscaPruebaCero()
{
    /* Busca la primera prueba cuyo resultado es >100 y que no se haya revisada ya (las revisadas se marcan como 33 o 44 o 22*/
    int i;
    for(i=0;i<PuntPruebas;i++){
        if(ListaPruebas[i].ResultadoPrueba>100){
